...
mod tests {
 ...
 fs::write(
 temp.path().join("README.md"),
 "Revolutionary new launch demo. high-quality and ready for production one-click showcase.",
 )?;
 ...
 fs::write(
 temp.path().join("README.md"),
 "Revolutionary new high-quality ready for production one-click demo.\n",
 )?;
